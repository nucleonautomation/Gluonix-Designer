...
- Container Config Size Change Wont Effect Inside Widgets
- GUI & POPUP Topbar Overide Bug Fix For Linux

## V(7.4)
- Canvas Image Based Editor Changed To Viewport
- Canvas Added New Editor, Raw Canvas Based, No Image, With Fill Color Items
- New Example Added For Both Editor/Viewport
...
## V(7.1)
- Element Resize In Designer Is Based On Quadrant Position. If Mouse Is In Left-Top Quadrant, Going Left Or Top Will Increase Size In Respective Direction
...
## V(7.0)
- Editor Added To Canvas, An Interactive Image Editor
- Support Image Zoom/Pan & Draw Rectangle, Line, Circle, Polyline, Polygon & Quadrilateral
- Support Draw Item Movements, Resize, Rotation
- All Items Position & Data Is Based Upon Actual Image Size, So It Can Be Easy To Get Item Coords In Image Coords
...
## V(6.2)
- Bug Fixes In ALL Image Widget Open, Error Out With Array
- Removed Requests Dependency In PIP Install

## V(6.1)
- Url, Array & Pil Flags Removed From All Image Widgets (Image, Image_Lite, Image_Zoom, Compound, Compound_Lite, Canvas_Image)
- All Image Widgets Will Can Take Local Path, Url Path, CV2 Frame (NP Array) & PIL Image Directly To Set Function Without Using Any Flags/Args

## V(6.0)
- Start-Up Version Check Bug Fixed, Bug Was In Find Fonts In Canvas_Test_Config
...
## V(5.8)
- Requests Dependency Removed, Switched To urllib

## V(5.7)
- Switch Widget Colors Fixed

## V(5.6)
- Root/Popup Icon Will Be Supported In All OS (Windows, Linux, MacOS etc), & All Image Files Are Accepted
...
- Canvas Image Item Width Height Config Fixed

## V(4.4)
- Canvas Item Widgets Bug Fix
- Design Grid Lock Fixed To Permanent Value
...
- Note: Check Switching From Dark To Light Or Vice Versa, It Only Works For Each Main Window. Has To Be Done Separately For Root & Popups
...
## V(1.8)
- Fixed: Naming While Copying A Widget. New Object Will Be Independent Object With Different Name
