...
def Load(Global):
    try:
        ...
        if len(Display)==1:
            ...
            Temp_Root.Config(Persistent=bool(int(Display['Persistent'])), Full_Screen=bool(int(Display['Full_Screen'])), Toolbar=bool(int(Display['Toolbar'])), Menu_Enable=bool(int(Display['Menu'])))
            Temp_Root.Create()
            Temp_Root.Hide()
...
def Create_Popup(Display):
    try:
        ...
        if len(Display)==1:
            ...
            Temp_Popup.Config(Persistent=bool(int(Display['Persistent'])), Full_Screen=bool(int(Display['Full_Screen'])), Toolbar=bool(int(Display['Toolbar'])), Topmost=bool(int(Display['Topmost'])), Menu_Enable=bool(int(Display['Menu'])))
            Temp_Popup.Create()
