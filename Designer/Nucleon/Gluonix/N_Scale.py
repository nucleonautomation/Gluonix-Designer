...
class Scale:
    ...
    def __init__(self, Main, *args, **kwargs):
        ...
        if self._GUI is not None:
            self._Type = "Scale"
            try:
                self._Config = ['Name', 'Auto_Dark', 'Background', 'Light_Background', 'Dark_Background', 'Foreground', 'Light_Foreground', 'Dark_Foreground', 'Border_Color', 'Light_Border_Color', 'Dark_Border_Color', 'Border_Size', 'Resize', 'Popup', 'Display', 'Left', 'Top', 'Width', 'Height', 'Increment', 'Minimum', 'Maximum', 'Orient', 'Disable', 'Hover_Background', 'Light_Hover_Background', 'Dark_Hover_Background', 'Hover_Foreground', 'Light_Hover_Foreground', 'Dark_Hover_Foreground', 'Hover_Border_Color', 'Light_Hover_Border_Color', 'Dark_Hover_Border_Color']
    ...
    def Create(self):
        try:
            ...
            if self._Orient=='Horizontal':
                Direction = TK.HORIZONTAL
                Minimum = self._Minimum
                Maximum = self._Maximum
                Width = self._Height
            else:
                Direction = TK.VERTICAL
