...
class Switch:
    ...
    def __init__(self, Main, *args, **kwargs):
        ...
        if self._GUI is not None:
            self._Type = "Switch"
            try:
                self._Config = ['Name', 'Auto_Dark', 'Background', 'Light_Background', 'Dark_Background', 'Resize', 'Popup', 'Display', 'Left', 'Top', 'Width', 'Height']
    ...
    def Create(self):
        try:
            ...
            if not self._Initialized:
                ...
                self._Frame.Config(Background=self._Background, Aspect_Ratio=False, Border_Size=0)
