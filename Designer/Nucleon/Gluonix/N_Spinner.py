...
class Spinner:
    ...
    def __init__(self, Main, *args, **kwargs):
        ...
        if self._GUI is not None:
            self._Type = "Spinner"
            try:
                self._Config = ['Name', 'Background', 'Foreground', 'Border_Color', 'Border_Size', 'Resize_Width', 'Resize', 'Resize_Height', 'Move', 'Move_Left', 'Move_Top', 'Popup', 'Display', 'Left', 'Top', 'Width', 'Height', 'Font_Size', 'Font_Weight', 'Font_Family', 'Align', 'Increment', 'Minimum', 'Maximum', 'Disable', 'Hover_Background', 'Hover_Foreground', 'Hover_Border_Color']
    ...
    def __str__(self):
        return "Nucleon_Glunoix_Spinner[]"
