...
class Bar:
    ...
    def __init__(self, Main, *args, **kwargs):
        ...
        if self._GUI is not None:
            self._Type = "Bar"
            try:
                self._Config = ['Name', 'Background', 'Light_Background', 'Dark_Background', 'Foreground', 'Light_Foreground', 'Dark_Foreground', 'Border_Color', 'Light_Border_Color', 'Dark_Border_Color', 'Border_Size', 'Resize_Width', 'Resize', 'Resize_Height', 'Move', 'Move_Left', 'Move_Top', 'Popup', 'Display', 'Left', 'Top', 'Width', 'Height', 'Progress', 'Zero', 'Hover_Background', 'Light_Hover_Background', 'Dark_Hover_Background', 'Hover_Foreground', 'Light_Hover_Foreground', 'Dark_Hover_Foreground', 'Hover_Border_Color', 'Light_Hover_Border_Color', 'Dark_Hover_Border_Color']
    ...
    def Display(self):
        try:
            ...
            if self._Progress>0:
                ...
                if self._Zero=='Left':
                    Width = (self._Width_Current-(self._Border_Size*2))*(self._Progress/100)
                    Height = self._Height_Current-(self._Border_Size*2)
                    Left = 0
                    Top = 0
                if self._Zero=='Right':
                    Width = (self._Width_Current-(self._Border_Size*2))*(self._Progress/100)
                    Height = self._Height_Current-(self._Border_Size*2)
                    Left = (self._Width_Current-self._Border_Size*2)*((100-self._Progress)/100)
                    Top = 0
                if self._Zero=='Top':
                    Width = self._Width_Current-(self._Border_Size*2)
                    Height = (self._Height_Current-(self._Border_Size*2))*(self._Progress/100)
                    Left = 0
                    Top = 0
                if self._Zero=='Bottom':
                    ...
                    Height = (self._Height_Current-(self._Border_Size*2))*(self._Progress/100)
                    Left = 0
                    Top = (self._Height_Current-self._Border_Size*2)*((100-self._Progress)/100)
                self._Widget.place(x=Left, y=Top, width=Width, height=Height)
            else:
