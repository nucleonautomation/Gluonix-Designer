...
class Configure_Compound_Lite:
    def __init__(self, Global, Configure):
        try:
            ...
            #Value Entry
            Fixture = self.Frame.Locate(60, 5, 28, 86)
            ...
            #Aspect Ratio Check
            Fixture = self.Frame.Locate(7, 5, 27.7, 121)
            ...
            #Image Label
            Fixture = self.Frame.Locate(25, 5, 3, 128)
            ...
            #Delete
            Fixture = self.Frame.Locate(7, 5, 18, 128)
            ...
            #Delete Comfirm
            Fixture = self.Frame.Locate(7, 5, 18, 135)
            ...
            #Image Image
            Fixture = self.Frame.Locate(60, 30, 28, 128)
