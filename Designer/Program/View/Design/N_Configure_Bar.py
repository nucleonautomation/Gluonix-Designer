...
class Configure_Bar:
    def __init__(self, Global, Configure):
        try:
            ...
            self.Progress_Label.Config(Width=Fixture[0], Height=Fixture[1], Left=Fixture[2], Top=Fixture[3])
            ...
            self.Progress_Entry.Config(Width=Fixture[0], Height=Fixture[1], Left=Fixture[2], Top=Fixture[3])
            ...
            self.Zero_Label.Config(Width=Fixture[0], Height=Fixture[1], Left=Fixture[2], Top=Fixture[3])
            ...
            self.Zero_Select.Config(Width=Fixture[0], Height=Fixture[1], Left=Fixture[2], Top=Fixture[3])
    ...
    def Update_Progress(self):
        try:
            ...
            if self.Global['Custom'].Is_Float(Progress):
                ...
                self.Progress_Entry.Config(Border_Color='red', Border_Size=2)
        except Exception as E:
            self.Global['Error'](__class__.__name__+" -> "+inspect.currentframe().f_code.co_name+" -> "+str(E))
