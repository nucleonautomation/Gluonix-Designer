        ...
        try:
            if ID:
                ...
                if len(Widget_Data)==1:
                    ...
                    Item1 = Widget.Add('Branch 01')
                    Widget.Add('Leaf 01', Parent=Item1)
                    Widget.Add('Leaf 02', Parent=Item1)
                    Widget.Add('Leaf 03', Parent=Item1)
                    Item2 = Widget.Add('Branch 02')
                    SubItem1 = Widget.Add('Inner Branch', Parent=Item2)
                    Widget.Add('Fruit 01', Parent=SubItem1)
                    Widget.Add('Fruit 02', Parent=SubItem1)
                    Widget.Add('Fruit 03', Parent=SubItem1)
                    Widget.Add('Leaf 02', Parent=Item2)
                    Widget.Add('Leaf 03', Parent=Item2)
                    Item3 = Widget.Add('Branch 03')
                    Widget.Add('Leaf 01', Parent=Item3)
                    Widget.Add('Leaf 02', Parent=Item3)
                    Widget.Add('Leaf 03', Parent=Item3)
