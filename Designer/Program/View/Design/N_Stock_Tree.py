...
class Stock_Tree:
    def __init__(self, Global, Stock, Left, Top):
        try:
            ...
            self.Label.Create()
            self.Label.Set(Path=self.Global['Image'](self.Type), Value=' Tree')
        ...
        try:
            if ID:
                ...
                if len(Widget_Data)==1:
                    ...
                    setattr(Root, ID, self.Global['Gluonix'].Tree(Root, Scroll=True))
                    Widget_Data = self.Stock.Design.Database.Get(f"SELECT * FROM `Widget` WHERE `ID`='{ID}'", Keys=True)
                    Widget_Data = Widget_Data[0]
                    ...
                    Item1 = Widget.Add('Gluonix 01')
                    Widget.Add('Nucleon 01', Parent=Item1)
                    Widget.Add('Nucleon 02', Parent=Item1)
                    Widget.Add('Nucleon 03', Parent=Item1)
                    Item2 = Widget.Add('Gluonix 02')
                    SubItem1 = Widget.Add('Nucleon 01', Parent=Item2)
                    Widget.Add('Elemento 01', Parent=SubItem1)
                    Widget.Add('Elemento 02', Parent=SubItem1)
                    Widget.Add('Elemento 03', Parent=SubItem1)
                    Widget.Add('Nucleon 02', Parent=Item2)
                    Widget.Add('Nucleon 03', Parent=Item2)
                    Item3 = Widget.Add('Gluonix 03')
                    Widget.Add('Nucleon 01', Parent=Item3)
                    Widget.Add('Nucleon 02', Parent=Item3)
                    Widget.Add('Nucleon 03', Parent=Item3)
