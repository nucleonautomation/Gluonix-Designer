...
class Configure_Line:
    def __init__(self, Global, Configure):
        try:
            ...
            #Resize Width Label
            Fixture = self.Frame.Locate(25, 5, 3, 57)
            ...
            #Resize Width Check
            Fixture = self.Frame.Locate(7, 5, 27.7, 56)
            ...
            #Resize Height Label
            Fixture = self.Frame.Locate(25, 5, 3, 63)
            ...
            #Resize Height Check
            Fixture = self.Frame.Locate(7, 5, 27.7, 62)
            ...
            #Move Left Label
            Fixture = self.Frame.Locate(25, 5, 3, 70)
            ...
            #Move Left Check
            Fixture = self.Frame.Locate(7, 5, 27.7, 69)
            ...
            #Move Top Label
            Fixture = self.Frame.Locate(25, 5, 3, 77)
            ...
            #Move Top Check
            Fixture = self.Frame.Locate(7, 5, 27.7, 76)
