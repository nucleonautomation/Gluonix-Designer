...
class Configure_Scale:
    def __init__(self, Global, Configure):
        try:
            ...
            self.Orient_Label.Config(Width=Fixture[0], Height=Fixture[1], Left=Fixture[2], Top=Fixture[3])
            ...
            self.Orient_Select.Config(Width=Fixture[0], Height=Fixture[1], Left=Fixture[2], Top=Fixture[3])
