...
class Configure_Label:
    def __init__(self, Global, Configure):
        try:
            ...
            self.Anchor_Label.Config(Width=Fixture[0], Height=Fixture[1], Left=Fixture[2], Top=Fixture[3], Resize=False, Move=False)
            ...
            self.Anchor_Select.Config(Width=Fixture[0], Height=Fixture[1], Left=Fixture[2], Top=Fixture[3], Resize=False, Move=False)
            ...
            self.Anchor_Select.Add('n')
            self.Anchor_Select.Add('nw')
            self.Anchor_Select.Add('ne')
            self.Anchor_Select.Add('e')
            self.Anchor_Select.Add('w')
            self.Anchor_Select.Add('s')
            self.Anchor_Select.Add('sw')
            self.Anchor_Select.Add('se')
